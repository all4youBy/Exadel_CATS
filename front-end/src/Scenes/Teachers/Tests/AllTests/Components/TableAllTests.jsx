...
import './TableAllTests.scss';
import { Table } from 'antd';
import ButtonEditTest from './ButtonEditTest';
...
const columns = [{
  ...
  render: () => (
    <div className="all-tasks-group-button">
      <div className="parent-button-edit-task"><ButtonEditTest/></div>
...
class TableAllTests extends React.PureComponent {
  state = {
    bordered: false,
    loading: false,
