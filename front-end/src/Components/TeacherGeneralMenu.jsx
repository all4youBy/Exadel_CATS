    ...
    return (
      ...
      >
        ...
        <SubMenu key="sub3" title={<span><Icon type="profile" /><span>Тесты</span></span>}>
          ...
          <Menu.Item key="7">Назначить тест</Menu.Item>
          <Menu.Item key="8">Проверить тест</Menu.Item>
          <Menu.Item key="9">Добавить вопрос</Menu.Item>
        </SubMenu>
        <SubMenu key="sub4" title={<span><Icon type="folder" /><span>Материалы</span></span>}>
          <Menu.Item key="10">Все материалы</Menu.Item>
          <Menu.Item key="11">Ваши материалы</Menu.Item>
          <Menu.Item key="12">Добавить материал</Menu.Item>
        </SubMenu>
      </Menu>
    );
  }
